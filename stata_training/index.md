...
* <span style="color:blue;font-size:28x;">History window</span>
* <span style="color:fuchsia;font-size:28px">Results window</span>
* <span style="color:green;font-size:28px">Command window</span>
* <span style="color:red;font-size:28px">Variables window</span>
* <span style="color:orange;font-size:28px">Properties window</span>
