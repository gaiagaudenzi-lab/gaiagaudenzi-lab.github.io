...
* <span style="color:blue;font-size:30x;">History window</span>
* <span style="color:fuchsia;font-size:30px">Results window</span>
* <span style="color:green;font-size:30px">Command window</span>
* <span style="color:red;font-size:30px">Variables window</span>
* <span style="color:orange;font-size:30px">Properties window</span>
